<x-app-layout>
    ...
    <div class="m-2 p-2 flex justify-end">
        <a href="{{ route('posts.create') }}" class="bg-blue-400 hover:bg-blue-600 text-white px-4 py-2 rounded">Add
            Post</a>
    </div>
            ...
            <tbody>
                @foreach ($posts as $post)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="py-4 px-6">
                            <img src="{{ url('/storage/' . $post->img) }}" class="w-20 h-auto" />
                        </td>
                        <td class="py-4 px-6">
                            {{ $post->title }}
                        </td>
                        ...
                        <td class="py-4 px-6">
                            <div class="flex space-x-2">
                                <a href="{{ route('posts.show', $post->id) }}"
                                    class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">Detail
                                </a>
